...
| :--- | :--- | :--- | :--- |
| **Platform Access** | ~600 - 1200 PLN + VAT | 0 PLN (seemingly) | 0 PLN (no licensing fees) |
| **Hosting (Stability & Speed)** | Included (remote servers) | ~300 - 600 PLN (shared hosting) | **0 PLN (Professional GitHub Hosting)** |
| **Maintenance & "Firefighting"** | English-only support | **1500 - 3000 PLN** (plugin & security expert) | Full care, zero stress for you |
| **.pl Domain** | ~150 PLN (often higher on renewal) | ~100 - 150 PLN | ~100 - 150 PLN |
| **Total Annual (Gross)** | **~900 - 1600 PLN** | **~2000 - 4000 PLN** | **The cost of your domain only** |
