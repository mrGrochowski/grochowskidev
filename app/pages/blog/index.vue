  ...
  return {
    ...
    'itemListElement': posts.value.map((post, index) => ({
      ...
      'item': {
        ...
        'url': `https://grochowski.it${post.path.replace(/^\/(en|pl)\//, '/')}`
      }
    }))
  }
})
        ...
        >
          <UBlogPost
            ...
            :ui="{
              ...
              image:
                'group-hover/blog-post:scale-105 rounded-lg shadow-lg border-4 border-muted ring-2 ring-default [object-position:var(--img-pos)]! [object-fit:var(--img-fit)]!',
              header:
                index % 2 === 0
